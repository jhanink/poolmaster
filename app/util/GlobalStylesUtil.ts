...
export const actionButtonStyles = `inline-flex text-gray-400 text-sm rounded-2xl border border-gray-600 px-4 py-1 ml-3 ${buttonHoverRing} hover:cursor-pointer`;
