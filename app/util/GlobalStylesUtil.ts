...
export const actionButtonStyles = `inline-flex text-gray-400 text-sm rounded-2xl border border-gray-600 items-center justify-center px-4 ml-2 py-1 ${buttonHoverRing} hover:cursor-pointer`;
