...
export const actionButtonStyles = `inline-flex items-center text-gray-400 text-sm rounded-2xl border border-gray-600 px-4 py-2 ml-3 ${buttonHoverRing} hover:cursor-pointer`;
