...
export const ADMIN_HEADER = `text-2xl mb-2 py-2 px-5 text-black bg-gray-300 rounded-lg w-full sticky top-[30px] absolute`;
export const ADMIN_CONTENT = `text-sm px-1`;
